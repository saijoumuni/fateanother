...
function Precache( context )
    ...
    PrecacheResource("soundfile", "soundevents/voscripts/game_sounds_vohen.vsndevts", context)
    PrecacheResource("soundfile", "soundevents/voscripts/game_sounds_vorystalmaiden.vsndevts", context)
    ...
    PrecacheResource("soundfile", "soundevents/voscripts/game_sounds_vo_legionommander.vsndevts", context)
